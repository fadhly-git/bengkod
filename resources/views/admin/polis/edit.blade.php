<x-layouts.app title="Edit Poli">
    ...
    <div class="ui-page-head">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="ui-title !text-[1.55rem] md:!text-[1.7rem]">Edit Poli</h2>
                <p class="ui-subtitle">Perbarui nama dan deskripsi poli sesuai kebutuhan operasional.</p>
            </div>
        </div>
    </div>
        ...
        <div class="ui-panel-body">
            ...
            <form action="{{ route('polis.update', $poli->id) }}" method="POST">
                ...
                <div class="ui-field mb-8">
                    ...
                    <p class="ui-help">Pastikan keterangan tetap ringkas agar mudah dibaca oleh pasien dan admin.</p>
