<x-layouts.app title="Tambah Obat">
    ...
    <div class="ui-page-head">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="ui-title !text-[1.55rem] md:!text-[1.7rem]">Tambah Obat</h2>
                <p class="ui-subtitle">Lengkapi data obat yang akan tersedia untuk resep dokter.</p>
            </div>
        </div>
    </div>
        ...
        <div class="ui-panel-body">
            <form action="{{ route('admin.obat.store') }}" method="POST">
                ...
                <div class="ui-field mb-5">
                    ...
                    <input type="text" name="nama_obat" value="{{ old('nama_obat') }}" class="ui-input @error('nama_obat') is-error @enderror" required>
                    @error('nama_obat')<p class="ui-error">{{ $message }}</p>@enderror
                </div>

                <div class="ui-field mb-5">
                    <label class="ui-label">Kemasan <span class="text-red-500">*</span></label>
                    <input type="text" name="kemasan" value="{{ old('kemasan') }}" class="ui-input @error('kemasan') is-error @enderror" required>
                ...
                <div class="ui-field mb-6">
                    ...
                    <input type="number" min="0" name="harga" value="{{ old('harga') }}" class="ui-input @error('harga') is-error @enderror" required>
                    @error('harga')<p class="ui-error">{{ $message }}</p>@enderror
                </div>

                <div class="ui-field mb-6">
                    <label class="ui-label">Stok Awal <span class="text-red-500">*</span></label>
                    <input type="number" min="0" name="stok" value="{{ old('stok', 0) }}" class="ui-input @error('stok') is-error @enderror" required>
