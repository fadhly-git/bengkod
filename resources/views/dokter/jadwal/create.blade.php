<x-layouts.app title="Tambah Jadwal Periksa">
    ...
    <div class="ui-page-head">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="ui-title !text-[1.55rem] md:!text-[1.7rem]">Tambah Jadwal Periksa</h2>
                <p class="ui-subtitle">Tentukan hari dan rentang jam praktik.</p>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('dokter.jadwal-periksa.store') }}" method="POST">
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-6">
                    <div class="ui-field">
                        ...
                        <input type="time" name="jam_mulai" value="{{ old('jam_mulai') }}" class="ui-input @error('jam_mulai') is-error @enderror" required>
                        @error('jam_mulai')<p class="ui-error">{{ $message }}</p>@enderror
                    </div>

                    <div class="ui-field">
                        <label class="ui-label">Jam Selesai <span class="text-red-500">*</span></label>
                        <input type="time" name="jam_selesai" value="{{ old('jam_selesai') }}" class="ui-input @error('jam_selesai') is-error @enderror" required>
